...
const Home = ({navigation}) => {
  ...
  const renderCategoryData = () => {
    ...
    let genres = [
      ...
      {type: 'Romance', color: COLORS.darkRed, textColor: COLORS.lightRed},
      {type: 'Drama', color: COLORS.darkBlue, textColor: COLORS.lightBlue},
    ];
            ...
            <View style={{flex: 1, marginLeft: SIZES.radius}}>
              ...
              <View style={{flexDirection: 'row', marginTop: SIZES.base}}>
                {genres.map((genre, idx) => {
                  return (
                    item.genre.includes(genre.type) && (
                      <View
                        key={idx}
                        style={{
                          justifyContent: 'center',
                        ...
                        <Text style={{...FONTS.body3, color: genre.textColor}}>
                          {genre.type}
                        </Text>
                      </View>
                    )
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: COLORS.black}}>
      ...
      <ScrollView style={{marginTop: SIZES.radius}}>
        {/* Books Section */}
        <View>{renderMyBooksSection(myBooks)}</View>
        {/* Categories Section  */}
